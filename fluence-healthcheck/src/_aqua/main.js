                      ...
                      (seq
                       (seq
                        (seq
                         ...
                         (call %init_peer_id% ("getDataSrv" "validatorPeer") [] validatorPeer)
                        )
                           ...
                           (seq
                            (seq
                               ...
                               (seq
                                (par
                                 (seq
                                  ...
                                  (xor
                                   (seq
                                    (call validatorPeer ("op" "identity") ["VALIDATOR REACHABLE"] $validatorStatus)
                                    (call -relay- ("op" "noop") [])
                                   )
                                   (seq
                                    (call -relay- ("op" "noop") [])
                             ...
                             (xor
                               ...
                               (xor
                                (seq
                                 (seq
                                  ...
                                  (call %init_peer_id% ("op" "concat_strings") ["target " targetPeer " validator " validatorPeer " status " targetStatus_gate-0.$.[0]] concat_strings)
                                 )
                              ...
                              (seq
                               (call %init_peer_id% ("op" "concat_strings") ["validator " validatorPeer " relay " -relay- " status " "VALIDATOR NOT REACHABLE"] concat_strings-0)
