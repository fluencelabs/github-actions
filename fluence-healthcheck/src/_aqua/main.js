...
export function registerConsole(...args) {
    registerService$$(
        args,
        {
...
export function checkNodeIsUp(...args) {
...
export function checkAllNodes(...args) {
                     ...
                     (seq
                      (seq
                       (seq
                        (seq
                         (call %init_peer_id% ("getDataSrv" "-relay-") [] -relay-)
                         (call %init_peer_id% ("getDataSrv" "setups") [] setups)
                        )
                        (call %init_peer_id% ("getDataSrv" "timeout") [] timeout)
                       )
                       (new $statuses
                        (seq
                         (seq
                          (fold setups setup-0
                           (seq
                            (seq
                                ...
                                (seq
                                 (seq
                                  (seq
                                    ...
                                    (seq
                                     (seq
                                      (seq
                                       ...
                                       (par
                                        (fold setup-0.$.validators! validator-0
                                         (par
                                          (new $targetStatus
                                           (new $validatorStatus
                                            (seq
                                               ...
                                               (xor
                                                (seq
                                                 (seq
                                                    ...
                                                    (par
                                                     (seq
                                                      ...
                                                      (xor
                                                       (seq
                                                        (seq
                                                         (call setup-0.$.target! ("op" "identity") ["TARGET REACHABLE"] $targetStatus)
                                                         (call validator-0 ("op" "noop") [])
                                                        )
                                                        (call -relay- ("op" "noop") [])
                                                       )
                                                  ...
                                                  (call %init_peer_id% ("op" "concat_strings") ["target " setup-0.$.target! " validator " validator-0 " status " targetStatus_gate-0.$.[0]!] concat_strings)
                                                 )
                                                 (ap concat_strings $reachability)
                                                )
                                                (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 4])
                                      ...
                                      (call %init_peer_id% ("op" "array_length") [setup-0.$.validators!] array_length)
                                     )
                                     (call %init_peer_id% ("math" "sub") [array_length 1] sub)
                                    )
                                    (new $reachability_test
                                   ...
                                   (call %init_peer_id% ("op" "array_length") [setup-0.$.validators!] array_length-0)
                                  )
                                  (call %init_peer_id% ("math" "sub") [array_length-0 1] sub-0)
                                 )
                                 (canon %init_peer_id% $reachability  #-reachability-fix-0)
                             ...
                             (fold -reachability-flat-0 status-0
                              (seq
                               (seq
                                (ap status-0 $statuses)
                                (call %init_peer_id% ("run-console" "print") [status-0])
                               )
                               (next status-0)
                              )
                             )
                          ...
                          (canon %init_peer_id% $statuses  #-statuses-fix-0)
                         )
                         (ap #-statuses-fix-0 -statuses-flat-0)
                        )
                       )
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [-statuses-flat-0])
                       (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 5])
                      )
                     )
                     (call %init_peer_id% ("errorHandlingSrv" "error") [%last_error% 6])
