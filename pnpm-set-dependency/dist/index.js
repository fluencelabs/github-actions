...
module.exports = eval("require")("@pnpm/find-workspace-packages");
...
"use strict";
module.exports = JSON.parse('{"name":"pnpm","description":"Fast, disk space efficient package manager","version":"8.4.0","bin":{"pnpm":"bin/pnpm.cjs","pnpx":"bin/pnpx.cjs"},"bugs":{"url":"https://github.com/pnpm/pnpm/issues"},"main":"bin/pnpm.cjs","unpkg":"dist/pnpm.cjs","files":["dist","bin"],"__optionalDependencies":{"node-gyp":"^9.3.1"},"__devDependencies":{"@pnpm/assert-project":"workspace:*","@pnpm/byline":"^1.0.0","@pnpm/cli-meta":"workspace:*","@pnpm/cli-utils":"workspace:*","@pnpm/client":"workspace:*","@pnpm/command":"workspace:*","@pnpm/common-cli-options-help":"workspace:*","@pnpm/config":"workspace:*","@pnpm/constants":"workspace:*","@pnpm/core-loggers":"workspace:*","@pnpm/default-reporter":"workspace:*","@pnpm/dependency-path":"workspace:*","@pnpm/filter-workspace-packages":"workspace:*","@pnpm/find-workspace-dir":"workspace:*","@pnpm/find-workspace-packages":"workspace:*","@pnpm/lockfile-types":"workspace:*","@pnpm/logger":"^5.0.0","@pnpm/modules-yaml":"workspace:*","@pnpm/nopt":"^0.2.1","@pnpm/parse-cli-args":"workspace:*","@pnpm/pick-registry-for-package":"workspace:*","@pnpm/plugin-commands-audit":"workspace:*","@pnpm/plugin-commands-config":"workspace:*","@pnpm/plugin-commands-deploy":"workspace:*","@pnpm/plugin-commands-doctor":"workspace:*","@pnpm/plugin-commands-env":"workspace:*","@pnpm/plugin-commands-init":"workspace:*","@pnpm/plugin-commands-installation":"workspace:*","@pnpm/plugin-commands-licenses":"workspace:*","@pnpm/plugin-commands-listing":"workspace:*","@pnpm/plugin-commands-outdated":"workspace:*","@pnpm/plugin-commands-patching":"workspace:*","@pnpm/plugin-commands-publishing":"workspace:*","@pnpm/plugin-commands-rebuild":"workspace:*","@pnpm/plugin-commands-script-runners":"workspace:*","@pnpm/plugin-commands-server":"workspace:*","@pnpm/plugin-commands-setup":"workspace:*","@pnpm/plugin-commands-store":"workspace:*","@pnpm/prepare":"workspace:*","@pnpm/read-package-json":"workspace:*","@pnpm/read-project-manifest":"workspace:*","@pnpm/registry-mock":"3.8.0","@pnpm/run-npm":"workspace:*","@pnpm/tabtab":"^0.1.2","@pnpm/test-fixtures":"workspace:*","@pnpm/types":"workspace:*","@pnpm/workspace.pkgs-graph":"workspace:*","@pnpm/write-project-manifest":"workspace:*","@types/cross-spawn":"^6.0.2","@types/is-windows":"^1.0.0","@types/pnpm__byline":"npm:@types/byline@^4.2.33","@types/ramda":"0.28.20","@types/semver":"7.3.13","@types/which":"^2.0.2","@zkochan/retry":"^0.2.0","@zkochan/rimraf":"^2.1.2","chalk":"^4.1.2","ci-info":"^3.8.0","cross-spawn":"^7.0.3","cross-var-no-babel":"^1.2.0","deep-require-cwd":"1.0.0","delay":"^5.0.0","dir-is-case-sensitive":"^2.0.0","esbuild":"^0.17.18","execa":"npm:safe-execa@0.1.2","exists-link":"2.0.0","is-windows":"^1.0.2","load-json-file":"^6.2.0","loud-rejection":"^2.2.0","normalize-newline":"3.0.0","npm-run-all":"^4.1.5","p-any":"3.0.0","p-defer":"^3.0.0","path-exists":"^4.0.0","path-name":"^1.0.0","pidtree":"^0.6.0","ps-list":"^7.2.0","ramda":"npm:@pnpm/ramda@0.28.1","read-yaml-file":"^2.1.0","render-help":"^1.0.3","semver":"^7.5.0","split-cmd":"^1.0.1","strip-ansi":"^6.0.1","symlink-dir":"^5.1.1","tempy":"^1.0.1","tree-kill":"^1.2.2","which":"^3.0.0","write-json-file":"^4.3.0","write-pkg":"4.0.0","write-yaml-file":"^5.0.0"},"directories":{"test":"test"},"homepage":"https://pnpm.io","keywords":["pnpm8","dependency manager","install","installer","uninstall","remove","link","prune","shrinkwrap","lockfile","fast","rapid","efficient","package.json","packages","dependencies","symlinks","hardlinks","modules","npm","package manager","monorepo","multi-package","workspace:*"],"license":"MIT","preferGlobal":true,"engines":{"node":">=16.14"},"repository":{"type":"git","url":"git+https://github.com/pnpm/pnpm.git"},"publishConfig":{"tag":"next-8","executableFiles":["./dist/node-gyp-bin/node-gyp","./dist/node-gyp-bin/node-gyp.cmd","./dist/node_modules/node-gyp/bin/node-gyp.js"]},"funding":"https://opencollective.com/pnpm","exports":{".":"./package.json"},"scripts":{"bundle":"cross-var esbuild lib/pnpm.js --bundle --platform=node --outfile=dist/pnpm.cjs --external:node-gyp --define:process.env.npm_package_name=\\\\\\"$npm_package_name\\\\\\" --define:process.env.npm_package_version=\\\\\\"$npm_package_version\\\\\\"","start":"tsc --watch","lint":"eslint \\"src/**/*.ts\\" \\"test/**/*.ts\\"","registry-mock":"registry-mock","test:jest":"jest","pretest:e2e":"rimraf node_modules/.bin/pnpm","test:e2e":"registry-mock prepare && run-p -r registry-mock test:jest","_test":"cross-env PNPM_REGISTRY_MOCK_PORT=7776 pnpm run test:e2e","test":"pnpm run compile && pnpm run _test","_compile":"tsc --build","compile":"tsc --build && pnpm run lint --fix && rimraf dist bin/nodes && pnpm run bundle && shx cp -r node-gyp-bin dist/node-gyp-bin && shx cp -r node_modules/@pnpm/tabtab/lib/scripts dist/scripts && shx cp -r node_modules/ps-list/vendor dist/vendor && shx cp pnpmrc dist/pnpmrc"}}');
...
const { findWorkspacePackages } = __nccwpck_require__(606);
const { readProjectManifest } = __nccwpck_require__(462);
